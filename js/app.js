        ...
        getElements: function () {
            ...
            task = ({
                template: function (desc) {
                    return '<li class="li-todo"><input name="done-todo" type="checkbox" id="squaredOne" class="done-todo"><p class="desc" style="width: 70%;">' + desc + '</p> <span class="close">X</span></li>';
                }
            });
            numOfTasks = $('.tasks');
            getTasks = 0;
